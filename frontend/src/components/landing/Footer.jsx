        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3.5 mt-2">
              <a href="https://x.com/nisant54321" aria-label="Twitter" className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-[#0E7490] hover:text-white flex items-center justify-center transition-all">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/vikash-kumar-fullstack/" aria-label="LinkedIn" className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-[#0E7490] hover:text-white flex items-center justify-center transition-all">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://github.com/vikash-kumar-fullstack/" aria-label="GitHub" className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-[#0E7490] hover:text-white flex items-center justify-center transition-all">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
