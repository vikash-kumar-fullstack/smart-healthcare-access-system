...
export const getHospitals = asyncHandler(async (req, res) => {
  const data = await hospitalAdmin.getHospitals();
...
export const getDoctors = asyncHandler(async (req, res) => {
  const data = await doctorAdmin.getDoctors();
...
export const getQueues = asyncHandler(async (req, res) => {
  const data = await queueAdmin.getQueues();
...
export const getReports = asyncHandler(async (req, res) => {
  const data = await reportsAdmin.getReports();
...
export const getAdminAudits = asyncHandler(async (req, res) => {
  const audits = await adminService.getAdminAudits();
